...
pub const dirs = struct {
    pub const _root = "";
    pub const _66uu44tm9pa6 = cache ++ "/../..";
    pub const _nj8usqhaks6k = cache ++ "/v/git/github.com/vrischmann/zig-sqlite/branch-master";
};
...
pub const package_data = struct {
    ...
    pub const _nj8usqhaks6k = Package{
        .directory = dirs._nj8usqhaks6k,
        .pkg = Pkg{ .name = "sqlite", .source = .{ .path = dirs._nj8usqhaks6k ++ "/sqlite.zig" }, .dependencies = null },
        .c_include_dirs = &.{ "c" },
        .c_source_files = &.{ "c/sqlite3.c" },
    };
    pub const _66uu44tm9pa6 = Package{
        .directory = dirs._66uu44tm9pa6,
    };
};
